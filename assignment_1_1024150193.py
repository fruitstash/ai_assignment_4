...
Original file is located at
    https://colab.research.google.com/drive/1TjPK8l-amCANvhqgdyt7dWWGE0fwgdnw
...
for i in range(1, n + 1):
  if i % 7 == 0 and i % 9 == 0:
    sum = sum + i
print("The sum of numbers divisible by 7 and 9 from 1 to", n, "is:", sum)
...
CGPA={1:9.8, 2:6.7, 4:4.8, 7:9.1, 8:8.3}
...
HomeTown={"Aviral":"Delhi", "Parth":"Gwalior", "Anil":"Mirzapur", "Pankaj":"Patna"}
print ("Original Dictionary --> ", HomeTown)
print ("Home Town of Aviral is --> ", HomeTown["Aviral"])
print ("Home Town of Parth is   --> ", HomeTown["Parth"])
...
# Method 2
T = tuple(["Kshaaunish", 'Choudhary', 3.14, 3])   # Convert list to tuple
#T = tuple(("Kshaaunish", 'Choudhary', 3.14, 3))  # Also Works
